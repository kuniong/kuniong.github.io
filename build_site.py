...
def build_home() -> None:
    ...
    <section class="academic-section">
      <div class="container">
        <h2>News</h2>
        <ul class="news-list">
          <li><span class="news-date">2026.06</span><span>Selected for the 16th Research Award for Young Researchers of the Operations Research Society of Japan.</span></li>
          <li><span class="news-date">2026</span><span>New paper published in <em>Case Studies on Transport Policy</em> on automated speed-enforcement allocation.</span></li>
          <li><span class="news-date">2025</span><span>New paper published in <em>Operations Research Letters</em> on subgame-perfect equilibrium in a strategic matching queue.</span></li>
        </ul>
      </div>
    </section>
...
def build_experience() -> None:
    ...
    <section class="section compact"><div class="container">
      ...
      <div class="award-grid">
        ...
        <div class="award"><span class="award-year">2023</span><strong>Alumni Association Esaki Award</strong><span>University of Tsukuba</span></div>
